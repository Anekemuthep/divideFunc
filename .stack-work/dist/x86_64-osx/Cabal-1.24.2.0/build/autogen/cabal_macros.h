...
/* package divideFunc-0.1.0.0 */
#define VERSION_divideFunc "0.1.0.0"
#define MIN_VERSION_divideFunc(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "divideFunc-0.1.0.0-6nIeJmYpbdCINbxV1MHNbI"

#define CURRENT_PACKAGE_KEY "divideFunc-0.1.0.0-6nIeJmYpbdCINbxV1MHNbI"
